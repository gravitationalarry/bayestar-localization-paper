...
\subsection{Barankin bound}

It is well known that the \ac{CRLB} is not a tight bound in the sense that there does not always exist an estimator that achieves it. Barankin derived a tight bound for any unbiased estimator \cite{barankin1949locally}.
