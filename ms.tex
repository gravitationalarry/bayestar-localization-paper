...
%
A wrinkle is that $\mathcal{I}_{\tau\tau}$ depends on the true value of $\rho$. If we make the further leap of evaluating the \ac{CRLB} \emph{at the value of the estimators}, we can write
%
\begin{eqnarray}
